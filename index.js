...
// Pie Chat with data based on complexity of English Words
...
const checkTextSimple = (text, commonWords) => {
  ...
  const textSimplicity = (numberMatches / wordsArray.length * 100).toFixed();
...
const data = {
            a: checkTextSimple("kzdv asklvn some kj jh hhhh?", common_1000_EnglishWords), 
            b: checkTextSimple("Is there ;madfb masvk mvm mm msdvka;m smv?", common_100_EnglishWords), 
            c: checkTextSimple("Is there dndskgn alfng lakn sfdv alfsdvkome new thing over there?", common_1000_EnglishWords)
          };
